...
public class ConvertAvroSchemaCustom extends AbstractKiteConvertProcessor {
    ...
    private static final Relationship FAILURE = new Relationship.Builder()
            ...
            .build();
    private static final String PROPERTY_NOT_USED_FOR_SCHEMA = "_property";
    //private static final Map<String, String> myProperty = new HashMap<>();
    /**
    ...
    public static final String DEFAULT_YEAR = "1912";
    public static final String DEFAULT_MALE_CONVERT = "1";
    public static final String DEFAULT_FEMALE_CONVERT = "0";
    ...
    @VisibleForTesting
    static final PropertyDescriptor YEAR_END = new PropertyDescriptor.Builder()
            .name("Year of tragedy")
            .description("Year of tragedy")
            .addValidator(StandardValidators.POSITIVE_INTEGER_VALIDATOR)
            .defaultValue(DEFAULT_YEAR).build();

    @VisibleForTesting
    static final PropertyDescriptor CONVERT_MALE_FOR_INT = new PropertyDescriptor.Builder()
            .name("Convert male for int")
            .description("Convert male for int, male = 1")
            .addValidator(StandardValidators.INTEGER_VALIDATOR)
            .defaultValue(DEFAULT_MALE_CONVERT).build();

    @VisibleForTesting
    static final PropertyDescriptor CONVERT_FEMALE_FOR_INT = new PropertyDescriptor.Builder()
            .name("Convert female for int")
            .description("Convert female for int, female = 0")
            .addValidator(StandardValidators.INTEGER_VALIDATOR)
            .defaultValue(DEFAULT_FEMALE_CONVERT).build();
    ...
    private static final List<PropertyDescriptor> PROPERTIES = ImmutableList
            ...
            .add(YEAR_END)
            .add(CONVERT_MALE_FOR_INT)
            .add(CONVERT_FEMALE_FOR_INT)
            .build();
                            ...
                            try (DataFileStream<Record> stream = new DataFileStream<Record>(
                                ...
                                try (DataFileWriter<Record> w = writer.create(
                                    ...
                                    for (Record record : stream) {
                                        try {
                                            getLogger().debug("record:" + record);
                                            Record converted = converter
                                                    .convert(record);
                                            getLogger().debug("converted:" + converted);
                                            w.append(converted);
                                            written.incrementAndGet();
                                        } catch (AvroRecordConverterCustom.AvroConversionException e) {
                                            failures.add(e);
                                            getLogger().error(
