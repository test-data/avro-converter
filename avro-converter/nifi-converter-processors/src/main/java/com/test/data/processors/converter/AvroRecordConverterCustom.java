 ...
 * conversion.
 */
public class AvroRecordConverterCustom {
    ...
    private static final String DEFAULT_MALE = "male";
    private static final String DEFAULT_FEMALE = "female";
    private static final Integer DEFAULT_GENDER_NAN = -1;

    /**
     * @param inputSchema  Schema of input record objects
     * @param outputSchema Schema of output record objects
     * @param fieldMapping Map from field name in input record to field name in output
     *                     record.
     ...
     *
     * @param input Input record to convert conforming to the inputSchema this
     *              converter was created with.
     * @return Record converted to the outputSchema this converter was created
     * with.
     * @throws AvroConversionException When schemas do not match or illegal conversions are
     ...
     * other types.
     *
     * @param content      The data to convert, generally taken from a field in an input
     *                     Record.
     * @param inputSchema  The schema of the content object
     * @param outputSchema The schema to convert to.
     * @return The content object, converted to the output schema.
     * @throws AvroConversionException When conversion is impossible, either because the output type
     ...
     *
     * @param s Schema to remove nillable from.
